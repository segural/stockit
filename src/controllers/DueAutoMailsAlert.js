...
const DueAutoMailsAlert = async function () {
    ...
    const postData = {
            ...
            "contenido": "<h1>Sistema Stock IT</h1>" + "<h2>Hay licencias vencidas que debe verificar: </h2> <br>" + objetoATablaHTML(items),
            "isHtml": true,
    };
...
module.exports = DueAutoMailsAlert;